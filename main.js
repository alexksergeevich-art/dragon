...
const BG_ANALYSIS = {
  ...
  rings: [
    { level: 1, x: 0.122, y: 0.805, w: 0.107, h: 0.036, power: 1.0 },
    { level: 2, x: 0.311, y: 0.806, w: 0.120, h: 0.037, power: 1.32 },
    { level: 3, x: 0.500, y: 0.807, w: 0.121, h: 0.037, power: 1.56 },
    { level: 4, x: 0.689, y: 0.806, w: 0.115, h: 0.036, power: 1.84 },
    { level: 5, x: 0.878, y: 0.804, w: 0.109, h: 0.035, power: 2.1 },
  ],
