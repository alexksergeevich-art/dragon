const VER = "dragon-polish-20260306c";
...
const BG_ANALYSIS = {
  ...
  rings: [
    { level: 1, x: 0.128, y: 0.807, w: 0.107, h: 0.036, power: 1.0 },
    { level: 2, x: 0.312, y: 0.808, w: 0.120, h: 0.037, power: 1.32 },
    { level: 3, x: 0.500, y: 0.809, w: 0.121, h: 0.037, power: 1.56 },
    { level: 4, x: 0.688, y: 0.808, w: 0.115, h: 0.036, power: 1.84 },
    { level: 5, x: 0.872, y: 0.807, w: 0.109, h: 0.035, power: 2.1 },
  ],
  dragon: { x: 0.602, y: 0.408 },
