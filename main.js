...
function heroDepthScale(yPx){
  ...
  // Hard Diablo perspective for heroes:
  // - near dragon: hero is much smaller
  // - on bridge: about 0.5x of spawn size
  // - spawn platform: original size
  return clamp(sampleTrack(t, [
    [0.00, 0.18],
    [0.20, 0.20],
    [0.34, 0.24],
    [0.48, 0.38],
...
function dragonDepthScale(yPx){
  ...
  // Dragon should still feel far away, but remain visually dominant.
  return clamp(sampleTrack(t, [
    [0.00, 0.64],
    [0.18, 0.68],
    [0.30, 0.72],
